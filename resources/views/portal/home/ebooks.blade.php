@if (isset($ebooks) && $ebooks->count())
    <section>
        @foreach ($ebooks as $ebook)
            <div class="overflow-hidden bg-gray-100 lg:bg-transparent lg:px-5 @if($ebooks->count() > 1 && !$loop->first) mt-20 lg:mt-0 @endif">
                <div class="mx-auto grid max-w-6xl grid-cols-1 grid-rows-[auto_1fr] gap-y-16 pt-16 md:pt-20 lg:grid-cols-12 lg:gap-y-20 lg:px-3 @if($loop->last) lg:pb-36 @else lg:pb-32 @endif  lg:pt-20 xl:py-32">
                    <div class="relative flex items-end lg:col-span-5 lg:row-span-2">
                        <div class="absolute -bottom-12 -top-20 left-0 right-1/2 z-10 @if($loop->last) rounded-br-[92px] @endif bg-gray-100 md:bottom-8 lg:-inset-y-32 lg:left-[-100vw] lg:right-full lg:-mr-40">
                        </div>
                        <div class="relative z-10 mx-auto flex w-64 rounded-xl bg-gray-200 shadow-xl md:w-80 lg:w-auto">
                    ...
                    <div class="relative px-4 sm:px-6 lg:col-span-7 lg:pb-14 lg:pl-16 lg:pr-0 xl:pl-20">
                        <div class="hidden lg:absolute lg:-top-32 lg:bottom-0 lg:left-[-100vw] lg:right-[-100vw] lg:block lg:bg-gray-100"></div>
